...
public final class Hash implements Type {
    ...
    private static Hash of(final String algorithm, final String salt, final int iterations, final String fieldName) {
    ...
    public static Hash valueOf(final String algorithm, final String salt, final int iterations, final String fieldName) {
