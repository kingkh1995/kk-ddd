...
public final class ValidateUtils {
  ...
  public static void minValue(
      BigDecimal value, BigDecimal min, boolean minInclusive, String fieldName) {
    nonNull(value, fieldName);
  ...
  public static void maxValue(
      BigDecimal value, BigDecimal max, boolean maxInclusive, String fieldName) {
    nonNull(value, fieldName);
  ...
  public static void maxLength(
      CharSequence charSequence, int max, boolean maxInclusive, String fieldName) {
