...
public class SimpleAccessConditionChecker implements AccessConditionChecker {

  private final SimpleAccessConditionPluginManager pluginManager;
  ...
  public boolean checkAccessConditionAfter(String accessCondition, Object target, Object Result) {
    return analyzeThenCheck(Result, accessCondition);
  }
   ...
   * @return 解析后校验的结果
   */
  private boolean analyzeThenCheck(Object obj, @NotBlank String condition) {
