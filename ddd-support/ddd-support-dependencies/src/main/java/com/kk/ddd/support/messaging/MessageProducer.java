...
public interface MessageProducer {
  ...
  default void sendAtLeastOnce(@NotBlank String topic, @NotNull Message<?> message)
   ...
   */
  void sendAtLeastOnce(
      @NotBlank String topic, String hashKey, @Size(min = 1) List<Message<?>> messages)
      throws MessagingException;
   ...
   */
  boolean sendInTransaction(
      @NotBlank String topic, @NotNull Message<?> message, @NotNull BooleanSupplier localAction)
      throws MessagingException;
}
